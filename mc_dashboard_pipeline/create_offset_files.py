'''
python create_offset_files.py -i "/work/pi_pgrabowicz_umass_edu/cbagchi/media_cloud_election_dashboard/data/mc_data_day_by_day/*/*/wikilinked/en/data_wikified.json"
'''

## Create offset files that contain the an article and the offset at which
## that article exists in the original JSON file for quick lookup without a 
## sequential scan of the entire JSON file
