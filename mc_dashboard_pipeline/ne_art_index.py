...
'''python ne_art_index.py -i /work/pi_pgrabowicz_umass_edu/cbagchi/media_cloud_election_dashboard/data/mc_data_day_by_day_all/indexes/2024-01-01_to_2024-01-08-v5_filtered.index -o /work/pi_pgrabowicz_umass_edu/cbagchi/media_cloud_election_dashboard/data/mc_data_day_by_day_all/indexes/2024-01-01_to_2024-01-08-v5_ne-art-wiki-filtered -s 0 -e 100000'''
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--index-filename", dest="index_filename",
                            ...
                            help="Index filename.")
    parser.add_argument("-o", "--ouput-filename", dest="output_filename",
                            required=True, type=str,
    ...
    #                         required=True, type=int,
    #                         help="Keep only top k named entities based on TF-IDF")
